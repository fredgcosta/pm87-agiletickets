...
public class Espetaculo {
	...
	public List<Sessao> criaSessoes(LocalDate inicio, LocalDate fim,
		...
		int quantidadeSessoes = totalDias / periodicidade.getDivisor();
		List<Sessao> sessoes = new ArrayList<Sessao>(quantidadeSessoes);
		for (int i = 0; i <= totalDias; i = i + periodicidade.getDivisor()) {
